...
<script type="text/javascript">
          $.ajax( {
              type : "Get", url : "QueryEmpBasicInfo", contentType : "application/json", dataType : 'json', data :  {
                  "empID" : "31"
              },
...
<body>
	...
	<div
		style="background: Green; width: 100%; padding: 5px 0px; margin: 10px 0px;">
		<p style="color: #fff; margin-left: 10px;">help from teja.com</p>
